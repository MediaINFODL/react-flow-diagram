...
export var assignStatusToStore = function assignStatusToStore(payload) {
  return {
    type: "STATUS/SET",
    payload: payload
  };
...
export var assignNewStatusToStore = function assignNewStatusToStore(payload) {
  return {
    type: "STATUS/UPDATE",
    payload: payload
  };
...
export var assignEmptyStatusToStore = function assignEmptyStatusToStore() {
  return {
    type: "STATUS/REMOVE",
    payload: undefined
  };
...
export var assignLabelToStore = function assignLabelToStore(payload) {
  return {
    type: "LABEL/SET",
    payload: payload
  };
...
export var assignEmptyLabelToStore = function assignEmptyLabelToStore() {
  return {
    type: "LABEL/REMOVE",
    payload: undefined
  };
